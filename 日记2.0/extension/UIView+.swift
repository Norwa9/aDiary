...
//MARK:-阴影和圆角
extension UIView{
    func setupShadow(opacity: Float = 0.7, radius: CGFloat = 1, offset:CGSize = .zero, color: UIColor = LWColorConstatnsManager.LWShodowColor) {
...
extension UIView{
    ...
    /// 按钮反馈
    func showBounceAnimation(_ completionBlock: @escaping () -> Void) {
